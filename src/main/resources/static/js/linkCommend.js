        ...
        success:function (data) {
            if(data['status']==200){
                ...
                $.each(data['result'],function (index, obj) {
                    ...
                    $(".friends .link-items").append(item);
                })
            }
...
function link_message_plus() {
    var item = '<h3>Comments |\n' +
        '                                <span>'+link_message_num+'条评论</span>\n' +
        '                            </h3>'
